# Vela
Vela - A simple and highly optimized rule engine in C that can be directly added to projects and used for speedy rule calculations
...
5. Bytecode compiler
6. Custom Arena Allocator [ COMPLETED ]


## Other features yet to implement (apart from optimizations):

1. integration possibilies with C/C++ (directly use functions of this engine and actually give function ptrs that get executed) [ COMPLETED ] `(but still awkward)`
